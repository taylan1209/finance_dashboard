...
2. Run `pnpm dribbble:capture`. Puppeteer signs in with the executive demo account, captures a full-page screenshot, and slices it into four section-aware segments saved under `dribbble-assets/screenshots/`.
